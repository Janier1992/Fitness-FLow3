            ...
            >
                ...
                <div className="p-6 md:p-8 flex-grow">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="lg:order-2">
                             <img src={exercise.imageUrl} alt={exercise.name} className="w-full h-64 object-cover rounded-xl shadow-md" />
                        </div>
                ...
                <div className="p-4 md:p-6 bg-slate-50 border-t border-slate-200 grid grid-cols-2 md:grid-cols-5 gap-4">
                    ...
                    <div className="col-span-2">
                         <button className="w-full bg-brand-primary hover:bg-brand-secondary text-white font-bold py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2">
